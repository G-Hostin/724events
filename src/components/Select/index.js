...
const Select = ({
  ...
  const changeValue = (newValue) => {
    onChange(newValue); // Appelé sans argument à la base donc evtType est undefined
    setValue(newValue);
    setCollapsed(true); // collapsed est un booleen pour fermer la liste donc true pas newValue
  };
  return (
